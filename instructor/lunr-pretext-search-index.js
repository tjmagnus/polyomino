...
},
{
  ...
  "body": " How to use this book  The author is writing this textbook during a 2023-2024 sabbatical. Updates and additions will be deployed every week or two to  An Instructor's Version is available to faculty upon request. Email the author at tmagnus@rivier.edu with your name, contact information, and the link to a webpage verifying your role as instructor. Suggestions on how to improve this textbook are welcome.   Exploration activities  Explorations are an essential part of this course. Students, often in groups, make sense of the mathematics and take ownership of the content by discovering relationships through hands-on activities. I am happy to share the classroom worksheets on which this course is based. In fact, I plan to continue to use handouts for most of the inclass explorations even after this textbook is complete. I plan to add many of these to an instructor-accessible website. If you need these sooner, email me!     Interactive Online Version  For those of you reading this in a PDF or in print, I encourage you to also check out the interactive online version, which makes navigating the book a little easier. Additionally, many of the activities are implemented as GeoGebra or Polypad applets, which allow you to work interactively inside the textbook. Some exercises can be checked inside the online textbook and hyperlinks to definitions and other items are included.  My hope is to add other features, like how-to-use-the-software videos, in the future. You can view the interactive version for free at .    "
},
{
