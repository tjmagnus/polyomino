...
{
  "id": "intro-apply-subsec-definingpolygons-18",
  "level": "2",
  "url": "sec-intro-apply.html#intro-apply-subsec-definingpolygons-18",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "congruent "
...
},
{
  ...
  "body": "Wonder in Mathematics  Insert the prompt for Wonder paper.  "
},
{
  ...
  "body": " Invitation to Overcome Challenges   Growing through Persistance  Have you ever watched a baby learn a new skill, like walking, crawling, or even rolling over? The child does not master the skill on the first try, but they are determined. They fall down, but they keep trying. They readjust what they are doing, figure out how to create momentum and balance, and finally succeed. Even then they may stumble, but they persist. In the process, they grow stronger and can apply these skills to later learning, like running, climbing the cabinets, and reaching the cookie jar.  Throughout our lives, we grow by challenging ourselves to move beyond our comfort zone. We learn to read and write, to play games and sports, to cook, make music, or other art. Our brains are muscles that develop as we attempt new challenges. The nature of mathematics involves struggling with a problem, trying different strategies, taking breaks but persisting, and learning from failed attempts. In the explorations in this section, you may find that some of the problems are easy, but others require looking at the problem in new ways and trying different strategies.   Triangles on a Geoboard   You may use tools that you remember from previous courses, such as the area formula for a triangle and the Pythagorean Theorem, as you complete this activity. We will explore why these formulas hold in .    In this exploration, we will work with a geoboard that has four rows and four columns of pins such as the one pictured below.   A grid with 16 dots arranged in four rows and four columns.      Measuring along any row, we will assume that the horizontal distance between neighboring dots on a geoboard is one unit. What is the distance across the top of the geoboard from the leftmost pin to the rightmost pin?    Similarly, the vertical distance between neighboring pins in any column will be one unit. Determine the area of the square whose vertices are the four outermost pins on this geoboard.    Determine the shortest diagonal distance between two pins. In other words, what is the distance from the pin in the upper left corner to the pin in the second row and second column?    What is the distance from the top left pin to the bottom right pin?       As we construct triangles and other shapes on our geoboard, note that each vertex must be one one of the sixteen pins.   An interactive GeoBoard is available at the Polypad by Mathigon, polypad.org\/DLddLdVKLW461A or use the embedded interactive in the hint below.      Construct a triangle with the smallest possible area. What is the area?     Construct a triangle with the largest possible area. Then construct a second triangle with the same area that is not the same shape as the first. Record your sketches and compute this area.      Interactive tool on Polypad by Mathigon         Construct triangles with an area different than any triangle you've already drawn. Counting the triangles you drew in , it is possible to create a total of eight triangles each with a different area. Be sure to record your sketches of the triangles and their areas for reference.     Interactive tool on Polypad by Mathigon    The possible areas are .    Extension: If we use a 5x5-geoboard instead, what squares and what triangles are possible? Compute the areas.      Confronting the Challenge  To give you the experience of confronting the challenge and the exhilaration of conquering it, the answer to the last task in this exploration will not be provided here. Searching for solutions or examples will not help you grow mathematically. Instead, consider other ways in which you might attack the problem. Dare to try something new!  The above exploration starts off relatively easy. Once students understand how to create and measure shapes on the geoboard, most can quickly find triangles with areas of , and . In fact, they find multiple triangles with these areas. Yet the remaining areas may seem impossible. At some point they begin to realize why they keep finding triangles with these five areas and begin to think differently about how they might create triangles on the geoboard.  With these new triangles, a new question emerges: How does one compute the area? To use the area formula, , one needs to know the values of and . How does one find and with certainty? Are there other ways of finding the area?  There are many lessons to be learned here that go beyond measuring area. Mathematics is not about doing fast calculations with provided formulas or following steps. Instead, it requires persistance, creative thinking, and multiple strategies. Sometimes it is helpful to walk away from a problem for a little while and to look at it differently when you return to it. It helps to share ideas with others even when you do not know where they will lead.  Did you discover a triangle that was not obvious? Did you think figure out a way to compute the area of these triangles? Did you help others understand? Be proud of your discoveries and contributions. You are a mathematician!  On the other hand, each student brings their own individual strengths to the class. Some are great at remembering and applying formulas, some are great at drawing sketches, some recognize patterns, some build on others' ideas, some explain results and connections. In fact, you may find yourself contributing in different ways on different activities. The important thing is to believe in yourself and be open to trying new things. Unfortunately, most people believe the lie that they can't do math and spend too much energy comparing themselves to others. Math is not about being perfect or fast. Instead it is about exploring, creating, experimenting, conjecturing, applying, and justifying.  If today was not your day to shine, perhaps you were hesitant to consider alternative approaches or to pursue your ideas. This particular topic might not have engaged you in the same way as it did others. Or maybe it was just an off day. There will be more opportunities to overcome challenges throughout this book, and so long as you are open to learning and exploring your own ideas, you will grow in mathematical ability and confidence. After all, the course has just started and you are just getting to know the book and its style, your instructor and your classmates. By the way, your brain may hurt a little as you confront and conquer mathematical challenges. Like every other muscle in your body, a little soreness means that you are growing in strength. Success comes from overcoming the struggle, from remembering and building on the accomplishments.    Exercises   Skills and Recall   Add problems.     Extending the Concepts   Add problems.     Writing Prompts  Wonder in Mathematics  Insert paper prompts here.     "
},
{
  ...
  "body": " Triangles on a Geoboard   You may use tools that you remember from previous courses, such as the area formula for a triangle and the Pythagorean Theorem, as you complete this activity. We will explore why these formulas hold in .    In this exploration, we will work with a geoboard that has four rows and four columns of pins such as the one pictured below.   A grid with 16 dots arranged in four rows and four columns.      Measuring along any row, we will assume that the horizontal distance between neighboring dots on a geoboard is one unit. What is the distance across the top of the geoboard from the leftmost pin to the rightmost pin?    Similarly, the vertical distance between neighboring pins in any column will be one unit. Determine the area of the square whose vertices are the four outermost pins on this geoboard.    Determine the shortest diagonal distance between two pins. In other words, what is the distance from the pin in the upper left corner to the pin in the second row and second column?    What is the distance from the top left pin to the bottom right pin?       As we construct triangles and other shapes on our geoboard, note that each vertex must be one one of the sixteen pins.   An interactive GeoBoard is available at the Polypad by Mathigon, polypad.org\/DLddLdVKLW461A or use the embedded interactive in the hint below.      Construct a triangle with the smallest possible area. What is the area?     Construct a triangle with the largest possible area. Then construct a second triangle with the same area that is not the same shape as the first. Record your sketches and compute this area.      Interactive tool on Polypad by Mathigon         Construct triangles with an area different than any triangle you've already drawn. Counting the triangles you drew in , it is possible to create a total of eight triangles each with a different area. Be sure to record your sketches of the triangles and their areas for reference.     Interactive tool on Polypad by Mathigon    The possible areas are .    Extension: If we use a 5x5-geoboard instead, what squares and what triangles are possible? Compute the areas.   "
},
{
  "id": "SAR-intro-struggle-insertname",
  "level": "2",
  "url": "sec-intro-struggle.html#SAR-intro-struggle-insertname",
  "type": "Exercise",
  "number": "1.4.3.1",
  "title": "",
  "body": " Add problems.  "
...
},
{
  ...
  "number": "1.4.3.3",
  "title": "Wonder in Mathematics.",
  "body": "Wonder in Mathematics  Insert paper prompts here.  "
},
{
  "id": "ch-intro-7",
  "level": "1",
