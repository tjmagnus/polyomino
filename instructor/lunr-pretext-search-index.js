...
},
{
  ...
  "number": "1.2.3",
  "title": "",
  "body": " Some examples of polygons    A right trapezoid   (for accessibility)     A concave pentagon.     "
},
{
...
},
{
  ...
  "number": "1.2.10",
  "title": "",
  "body": " triangle right  triangle acute  triangle obtuse  right triangle  acute triangle  obtuse triangle   A triangle is said to be a right triangle if one of its angles is a right angle. If one of its angles is obtuse, we say that the triangle is an obtuse triangle . An acute triangle is a triangle with three acute angles. We will explore the measurement of angles more in and .   "
},
{
  "id": "def-rectquads",
  "level": "2",
...
{
  "id": "intro-apply-subsec-definingpolygons-21",
  "level": "2",
  "url": "sec-intro-apply.html#intro-apply-subsec-definingpolygons-21",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "congruent "
...
{
  "id": "ExtConc-intro-share-2",
  "level": "2",
  "url": "sec-intro-share.html#ExtConc-intro-share-2",
  "type": "Exercise",
  "number": "1.3.4.2",
  "title": "",
  "body": " Add problems.  "
...
},
{
  ...
  "number": "1.4.3.1",
  "title": "",
  "body": "  square root   The square root of a number is the nonnegative number such that . We use the notation to represent the square root of .    Compute the following numbers if they exist.                                  "
},
{
...
{
  "id": "writing-intro-struggle-prompt",
  "level": "2",
  "url": "sec-intro-struggle.html#writing-intro-struggle-prompt",
  "type": "Exercise",
  "number": "1.4.3.3",
...
},
{
  ...
  "number": "2.3.5",
  "title": "",
  "body": "  Given two parallel lines and and a line that crosses and , corresponding angles have the same angle measure.   "
},
{
  "id": "principle-trisum",
  "level": "2",
  ...
  "number": "2.3.6",
  "title": "",
  "body": "  The sum of the interior angles of any triangle is 180 degrees.   "
},
{
...
{
  "id": "sec-polygons-length-4-3-2",
  "level": "2",
  "url": "sec-polygons-length.html#sec-polygons-length-4-3-2",
  "type": "Reading Question",
  "number": "2.5.2.1",
  "title": "",
...
{
  "id": "sec-polygons-length-4-3-3",
  "level": "2",
  "url": "sec-polygons-length.html#sec-polygons-length-4-3-3",
  "type": "Reading Question",
  "number": "2.5.2.2",
  "title": "",
...
},
{
  ...
  "body": " Prisms and Cylinders   Definitions  Add here.   "
},
{
...
},
{
  ...
  "type": "Section",
  "number": "B.1",
  "title": "Principles of Algebra",
  "body": " Principles of Algebra   expression  equation  algebraic expression  algebraic equation   An expression in mathematics is a representation of a numerical quantity consisting of a finite number of variables and\/or numbers joined by algebraic operations such as addition, subtraction, multiplication, division, and exponentiation. An expression is said to be algebraic if it contains at least one variable.     Field Properties of the Real Numbers  We summarize the principles that define operations on the set of real numbers. Methods of performing calculations, simplifying algebraic expressions, and solving equations follow from these principles.   Closure of Addition and Multiplication on the Set of Real Numbers   If and are real numbers, then and are real numbers.     Commutative Laws   If and are real numbers, then and .     Associative Laws   If , , and are real numbers, then and .     The Distributive Law   If , , and are real numbers, then and .  Note that the distributive law also allows us to add fractions with a common denominator; In short,      The Identity Properties   If is an real number, then , , , and We call 0 the additive identity and 1 the multiplicative identity .       Working with squares and square roots The notation is read -squared and is equivalent to the product . Later in this text we will be interested in cubing a number which we can write as or . On the set of nonnegative numbers A number is said to be nonnegative if . The square root cannot undo the action of squaring a negative number like because . , the square root acts as the inverse (or \"undoing\") function of the squaring function. Thus, whenever you would like to undo the squaring function in an equation such as in the above example, we will take the square root of both sides. Hence, the equation in the Pythagorean Theorem can be written equivalently as or . Note the inverse action: . In fact, the squaring function also undoes the square root function: . This is what we mean by a pair of inverse functions; applying them one right after the other (in either order) cancels their action. Examples of inverse function pairs that you may be more familiar with include adding 4 and subtracting 4 and also dividing by 10 and multiplying by 10. Note how the two functions undo each other and recall how you have used them to solve equations. The cubing function and cube root function are also inverses.  "
},
{
  "id": "def-expression",
  "level": "2",
